...
Feature: Question states and visibility
  ...
  Scenario: Pin question
    ...
    And "//img[contains(@src, '/sticky')]" "xpath_element" should exist in the "TF 01" "table_row"
    And "//img[contains(@src, '/sticky')]" "xpath_element" should not exist in the "TF 02" "table_row"
    And I log out
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "StudentQuiz Test 1"
